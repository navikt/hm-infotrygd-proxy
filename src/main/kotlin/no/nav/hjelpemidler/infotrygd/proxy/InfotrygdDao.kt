    ...
    fun hentBrevstatistikk(
        ...
        return tx.list(
            """
                ...
                GROUP BY S10.S10_BEHEN_ENHET, TO_DATE(LPAD(S10.S10_VEDTAKSDATO, 8, '0') DEFAULT '01011900' ON CONVERSION ERROR, 'DDMMYYYY'), CASE WHEN PKER.F_NR IS NOT NULL THEN 1 ELSE 0 END, S20.S20_TEKSTKODE_1, S10.S10_VALG, S10.S10_UNDERVALG, S10.S10_TYPE, S10.S10_RESULTAT
                ORDER BY S10.S10_BEHEN_ENHET, TO_DATE(LPAD(S10.S10_VEDTAKSDATO, 8, '0') DEFAULT '01011900' ON CONVERSION ERROR, 'DDMMYYYY'), CASE WHEN PKER.F_NR IS NOT NULL THEN 1 ELSE 0 END, S20.S20_TEKSTKODE_1, S10.S10_VALG, S10.S10_UNDERVALG, S10.S10_TYPE, S10.S10_RESULTAT
            """.trimIndent(),
            mapOf(

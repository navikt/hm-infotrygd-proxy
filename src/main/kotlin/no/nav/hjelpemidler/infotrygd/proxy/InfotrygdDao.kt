        ...
        return tx.list(
            """
                SELECT
                    ...
                    (CASE WHEN OIDER.OPPGAVE_ID IS NOT NULL THEN true ELSE false END) as DIGITAL,
                    S20.S20_TEKSTKODE_1 as BREVKODE,
                    S10.S10_VALG,
                    S10.S10_UNDERVALG,
                    S10.S10_TYPE,
                ...
                WHERE
                    ...
                    AND S20.S20_SAKSNR        = S10.S10_SAKSNR
                    AND S20.S20_TEKSTKODE_1  <> '    '
                GROUP BY S10.S10_BEHEN_ENHET, TO_DATE(S10.S10_VEDTAKSDATO DEFAULT '01011900' ON CONVERSION ERROR, 'DDMMYYYY'), CASE WHEN OIDER.OPPGAVE_ID IS NOT NULL THEN true ELSE false END, S20.S20_TEKSTKODE_1, S10.S10_VALG, S10.S10_UNDERVALG, S10.S10_TYPE, S10.S10_RESULTAT
                ORDER BY S10.S10_BEHEN_ENHET, TO_DATE(S10.S10_VEDTAKSDATO DEFAULT '01011900' ON CONVERSION ERROR, 'DDMMYYYY'), CASE WHEN OIDER.OPPGAVE_ID IS NOT NULL THEN true ELSE false END, S20.S20_TEKSTKODE_1, S10.S10_VALG, S10.S10_UNDERVALG, S10.S10_TYPE, S10.S10_RESULTAT
            """.trimIndent(),
            mapOf(
                "enhet" to enhet,
                "maksDato" to maksVedtaksdato,
